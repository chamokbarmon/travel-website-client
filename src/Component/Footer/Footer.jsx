const Footer = () => {
    return (
        <div>
        <footer className="footer p-10 bg-gray-900 text-white w-screen">
        <div>
      ...
      <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 w-screen">
